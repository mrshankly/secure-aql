...
set_table_level(undefined, CRP) ->
    CRP;
set_table_level(Rule, ?T_CRP(Rule, _, _) = CRP) ->
    CRP;
...
set_dep_level(undefined, CRP) ->
    CRP;
set_dep_level(Rule, ?T_CRP(_, Rule, _) = CRP) ->
    CRP;
...
set_p_dep_level(undefined, CRP) ->
    CRP;
set_p_dep_level(Rule, ?T_CRP(_, _, Rule) = CRP) ->
    CRP;
